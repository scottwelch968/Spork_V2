          ...
          {isLoadingStats ? (
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="p-4 rounded-lg bg-muted/50">
                ...
                <div className="text-sm text-muted-foreground">Personal Files</div>
              </div>
              <div className="p-4 rounded-lg bg-muted/50">
                <div className="text-2xl font-bold">{stats?.totalWorkspaceFiles || 0}</div>
                <div className="text-sm text-muted-foreground">Workspace Files</div>
              </div>
              <div className="p-4 rounded-lg bg-muted/50">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            This can happen when files are manually deleted from storage or if delete operations partially fail.
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          {orphanedFiles.length === 0 && !isScanning && (
            <div className="text-center py-8 text-muted-foreground">
              ...
              {hasScanned ? (
                <p className="text-green-600 font-medium">All files are healthy - no orphaned records found.</p>
              ) : (
                <>
