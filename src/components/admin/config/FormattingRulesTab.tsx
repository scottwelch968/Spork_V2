...
// Use canonical ResponseFormattingRules from contracts
// Local FormattingConfig interface deleted per COSMO Constitution Article II
      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-sm text-muted-foreground">
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              <h4 className="font-medium text-foreground">Injection Order</h4>
