    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Configure payment provider integrations</p>
        </div>
          ...
          <Card key={processor.id}>
            ...
            <CardContent>
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center gap-2">
                  <span className="text-muted-foreground">One-Time Payments:</span>
                ...
                {processor.webhook_url && (
                  <div className="flex items-center gap-2">
                    ...
                    <code className="text-xs bg-muted px-2 py-1 rounded">{processor.webhook_url}</code>
