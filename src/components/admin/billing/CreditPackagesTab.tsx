  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-semibold font-roboto-slab">Credit Packages</h2>
          <p className="text-muted-foreground">Manage purchasable credit packages for users</p>
        </div>
      ...
      {packages.length === 0 && (
        <Card>
          <CardContent className="text-center py-12">
            ...
            <p className="text-muted-foreground">No credit packages yet</p>
