...
export default function AdminMaintenance() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-roboto-slab font-semibold text-[#464646]">Maintenance</h1>
        <p className="text-muted-foreground">Manage scheduled jobs and view execution history</p>
      </div>
