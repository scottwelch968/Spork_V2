                  ...
                  <Card key={rule.id}>
                    ...
                    <CardContent>
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                        <div>
                          <p className="text-sm text-admin-text-muted">Event</p>
                          <p className="font-medium text-sm">{rule.event_type}</p>
                        </div>
                        <div>
                          <p className="text-sm text-admin-text-muted">Template</p>
                          <p className="font-medium text-sm">{rule.email_templates?.name}</p>
                        </div>
                        <div>
                          <p className="text-sm text-admin-text-muted">Triggered</p>
                          <p className="font-medium text-sm">{rule.trigger_count} times</p>
                        </div>
                        <div>
                          <p className="text-sm text-admin-text-muted">Success Rate</p>
