...
|-------|--------------|-------|-------|
| `admin-bg` | `--admin-bg` | `0 0% 99%` (Off-White) | Main background |
| `admin-bg-elevated` | `--admin-bg-elevated` | `0 0% 100%` | Cards, modals |
| `admin-bg-muted` | `--admin-bg-muted` | `240 5% 96%` | Muted backgrounds |
| `admin-bg-subtle` | `--admin-bg-subtle` | `240 5% 96%` | Subtle sections |
...
| Token | CSS Variable | Value | Usage |
|-------|--------------|-------|-------|
| `admin-accent` | `--admin-accent` | `188 70% 34%` (Teal) | Primary actions/Brand |
| `admin-accent-hover` | `--admin-accent-hover` | `188 70% 30%` | Hover state |
| `admin-accent-muted` | `--admin-accent-muted` | `240 5% 96%` | Subtle accent |
